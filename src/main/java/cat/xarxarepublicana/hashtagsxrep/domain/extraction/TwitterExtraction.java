...
public class TwitterExtraction {
    ...
    public TwitterExtraction(String monitorId, String tweetId, String userId, String type, LocalDateTime creationDate, String interactedStatusId, String interactedUserId, String language, String text) {
