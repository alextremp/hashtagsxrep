...
public class Report {
  ...
  public Report(
      TweetedContentResume tweetedContentResume,
      InteractorResume interactorResume,
      Integer taggersCount,
      Integer maxImpressions,
      Integer maxAudience,
      UserContentResume userContentResume) {
    this.tweetedContentResume =
        tweetedContentResume != null ? tweetedContentResume : new TweetedContentResume(0, 0, 0, 0);
